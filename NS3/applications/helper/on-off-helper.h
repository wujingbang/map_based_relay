...
public:
  ...
  OnOffHelper (std::string protocol, Address address, bool bindtoDevice, NetDeviceContainer devices);
  /**
...
private:
  ...
  Ptr<Application> InstallPriv (Ptr<Node> node, Ptr<NetDevice> device) const;
